...
let API = {
  ...
  call: (e, r, o, t) => {
    ...
    return t || (t = "server"), o || (o = {}), aliases[e] && (e = aliases[e]), new Promise((r, o) => {
      ...
      return s.latency_ms = (new Date).getTime() - n, s.requestId = i, "REDIRECT" === a.mode && "string" == typeof a.url && (s.redirect = a.url), config.get("server:api:debug:successResponse") && console.log("API success - ", e, "*", t, "\n\tUser:", r, "\n\tParam:", o, "\n\tResponse:", s), s
